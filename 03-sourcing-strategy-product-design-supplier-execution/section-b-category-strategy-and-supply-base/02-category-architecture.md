...
```mermaid
flowchart TD
    A["Clean supplier and item data"] --> B
    B["Group by supply market and business use"] --> C
    C["Set category and subcategory boundaries"] --> D
    D["Assign an accountable owner"] --> E
    E["Write the category strategy"]
```
