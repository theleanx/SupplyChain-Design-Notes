...
```mermaid
flowchart LR
    G[Global expansion] --> X[More nodes, borders, lead times, and coordination]
    P[Larger / more complex projects] --> X
    V[Greater market volatility] --> X
    X --> R[Need for visibility, collaboration, flexibility, and local knowledge]
```
